...
var showAlert = function showAlert(type, message) {
  hideAlert();
  var alertEl = "<h3 class=\" alert alert--".concat(type, "\">").concat(message, "</h3>");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (data.data.status === 'success') {
              (0, _alert.showAlert)(data.data.status, 'login success');
              setTimeout(function () {
                location.assign('/');
              }, 500);
            }
          ...
          case 8:
            ...
            (0, _alert.showAlert)(_data.type, _data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.get('http://localhost:3000/logout');
          ...
          case 3:
            ...
            if (data.data.type === 'success') {
              (0, _alert.showAlert)(data.data.status, 'logout successfully');
              location.assign('/');
            }
...
var updateUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(type, body) {
    var url, data, _data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (data.data.status === 'success') {
              (0, _alert.showAlert)(data.data.status, 'Updated successfully');
              setTimeout(function () {
                location.reload();
              }, 500);
            }
...
var setMap = function setMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWVldC12YWdoYXNpeWF5YSIsImEiOiJjbDcyNnYzZ2owaGxwM29uOWZlNWNpZTE3In0.N0gA8yWoS0-gFZq-vqe3Zg';
...
var stripe = Stripe('pk_test_51JWb7oLkbJrjpOnqxavKMHzk649CvjZbXVEwMVUaawOmIwqEyLPfNcgApmeNPzaQpHvW2BqBO751kkkur7ty11gi00w7kdPNU0');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post("http://localhost:3000/api/v1/booking/checkout/".concat(tourId));
...
var bookingEl = document.getElementById('book-now');

if (mapEl) {
  var locations = mapEl.dataset.locations;
  locations = JSON.parse(locations);

  if (locations) {
    (0, _mapbox.setMap)(locations);
  }
}

(_document$getElementB = document.getElementById('form')) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.addEventListener('submit', function (e) {
  e.preventDefault();
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  (0, _login.login)(email, password);
});
var profileEl = document.getElementById('form-user-data');
profileEl === null || profileEl === void 0 ? void 0 : profileEl.addEventListener('submit', function (e) {
  e.preventDefault();
  ...
  (0, _updateUser.updateUser)('user', formData);
});
var passwordForm = document.getElementById('form-user-settings');
passwordForm === null || passwordForm === void 0 ? void 0 : passwordForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var password = document.getElementById('password-current').value;
  var newPassword = document.getElementById('password').value;
  var confirmPassword = document.getElementById('password-confirm').value;
  (0, _updateUser.updateUser)('password', {
    password: password,
